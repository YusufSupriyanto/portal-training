...
<div class="card m-1">
    <form method="post" action="<?= base_url() ?>/send_evaluasi_reaksi_unplanned">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><input class="form-check-input" type="radio" value="4" name="program_training[]" required></td>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><input class="form-control input-sm" type="text" name="kemampuan_mengendalikan1" required></td>
        ...
        <div class="form-group m-3">
            <label class="ml-2">Selama mengikuti training ini, insight (wawasan) apa yang anda dapatkan ? <span
                    style="color:red;">*</span></label>
            <textarea class="form-control m-2" rows="3" placeholder="Enter ..." name="wawasan" required></textarea>
        </div>
        <div class="d-flex flex-row">
            <div class="card m-3">
                <label class="ml-2">Seberapa banyak anda mendapatkan pengetahuan/skill baru dari training ini ? <span
                        style="color:red;">*</span></label>
