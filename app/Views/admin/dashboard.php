...
document.addEventListener('DOMContentLoaded', function() {
    ...
    Highcharts.chart('training', {
        ...
        subtitle: {
            text: `<div class="d-flex justify-content-between" style="width:100%;height:100%"><div><h6 style="font-size:15px"><?= $CountImplemented[0]['training'] ?> &emsp;&emsp;&emsp;&emsp;&emsp;<span style="color: green;"><?= number_format($PercentImplemented, 0, ',', '.') . '%'; ?></span> &emsp;&emsp; &emsp; &emsp; &emsp; &emsp;  &emsp; &emsp;</h6></div><div><h6 style="font-size:15px"><?= $CountNotImplemented[0]['training'] ?> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp; <span style="color: red;"><?= number_format($PercentNotImplemented, 0, ',', '.') . '%' ?></span></h6></div></div>`
        },
        xAxis: {
            categories: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov',
                'Dec'
